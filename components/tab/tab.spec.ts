...
import { TabModule, NavbarComponent, TabbarComponent, TabDirective } from '../tab';

const TABS: any[] = [
    { heading: 'tab1', content: 'tab1 content', active: true, icon: '<img src="./assets/images/icon_tabbar.png">', badge: 8 },
    { heading: 'tab2', content: 'tab2 content', active: false, icon: '<img src="./assets/images/icon_tabbar.png">', badge: 'dot' },
...
describe('Component: Tabs', () => {
    ...
    describe('[Navbar]', () => {
        ...
        beforeEach(fakeAsync(() => {
            ...
            TestBed.overrideComponent(TestTabComponent, { set: { template: navbar_html } });
    ...
    describe('[Tabbar]', () => {
        ...
        beforeEach(fakeAsync(() => {
            ...
            TestBed.overrideComponent(TestTabComponent, { set: { template: tabbar_html } });
            fixture = TestBed.createComponent(TestTabComponent);
            context = fixture.componentInstance;
            spyOn(context, '_select');
            spyOn(context, '_deselect');
...
class TestTabComponent {
    ...
    _select(e: TabModule): TabModule { return e; }

    _deselect(e: TabModule): TabModule { return e; }

    _removed(e: TabModule): TabModule { return e; }
}
