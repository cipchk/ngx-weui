...
describe('Component: file-thumb', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.overrideComponent(TestFileThumbComponent, { set: { template: html } });
    ...
    it('should be init', () => {
        fixture.componentInstance.file = new File(['iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkWK1WDwAC1gFS81OXVgAAAABJRU5ErkJggg=='],
