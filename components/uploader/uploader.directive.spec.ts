...
describe('Component: Uploader', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.overrideComponent(TestUploaderDirectiveComponent, { set: { template: html } });
    ...
    describe('CLASS', () => {
        ...
        const file1 = new File(['iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkWK1WDwAC1gFS81OXVgAAAABJRU5ErkJggg=='], 'file1.png', { type: 'image/png' });
        const file2 = new File(['iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkWK1WDwAC1gFS81OXVgAAAABJRU5ErkJggg=='], 'file2.png', { type: 'image/png' });
